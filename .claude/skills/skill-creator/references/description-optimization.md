...
Companion to the "Description Optimization" phase of [[skill-creator]]. The `description` frontmatter field is the primary mechanism that determines whether Claude invokes a skill. After creating or improving a skill, offer to optimize it for better triggering accuracy.
