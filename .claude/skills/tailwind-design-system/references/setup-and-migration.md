# Tailwind Design System — Setup & Migration

Companion to `SKILL.md`. Read this when scaffolding a v4 project's CSS-first config, or migrating an existing v3 project (see `SKILL.md > Key v4 Changes` for the pattern-level diff).
