...
export function ChangeloopWordmark(props: { class?: string }) {
  return (
    <svg
      role="img"
      aria-label="Changeloop"
      data-component="changeloop-wordmark"
      viewBox="0 0 310 25"
      class={props.class}
      fill="currentColor"
    >
      <g opacity="0.6">
        <For each={pixels}>
          {(pixel) => (
            <rect x={pixel.x * 5} y={pixel.y * 5} width="4.8" height="4.8" opacity={pixel.x < 34 ? "0.6" : "1"} />
          )}
        </For>
      </g>
    </svg>
...
export function ChangeloopMark(props: { class?: string }) {
  return (
    <svg
      role="img"
      aria-label="Changeloop"
      data-component="changeloop-mark"
      viewBox="0 0 7 5"
      class={props.class}
      fill="currentColor"
    >
