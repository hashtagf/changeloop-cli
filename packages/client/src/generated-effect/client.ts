...
type Endpoint3_7Request = Parameters<RawClient["server.session"]["session.command"]>[0]
type Endpoint3_7Input = {
  readonly sessionID: Endpoint3_7Request["params"]["sessionID"]
  readonly id?: Endpoint3_7Request["payload"]["id"]
  readonly command: Endpoint3_7Request["payload"]["command"]
  readonly arguments?: Endpoint3_7Request["payload"]["arguments"]
  readonly agent?: Endpoint3_7Request["payload"]["agent"]
  readonly model?: Endpoint3_7Request["payload"]["model"]
  readonly files?: Endpoint3_7Request["payload"]["files"]
  readonly agents?: Endpoint3_7Request["payload"]["agents"]
...
type Endpoint18_0Request = Parameters<RawClient["server.foundation"]["foundation.investigations"]>[0]
type Endpoint18_0Input = {
  ...
  readonly offset?: Endpoint18_0Request["query"]["offset"]
  readonly limit?: Endpoint18_0Request["query"]["limit"]
}
const Endpoint18_0 = (raw: RawClient["server.foundation"]) => (input?: Endpoint18_0Input) =>
  raw["foundation.investigations"]({
    query: {
...
type Endpoint18_1Request = Parameters<RawClient["server.foundation"]["foundation.investigation"]>[0]
type Endpoint18_1Input = {
  readonly investigationID: Endpoint18_1Request["params"]["investigationID"]
  readonly location?: Endpoint18_1Request["query"]["location"]
}
const Endpoint18_1 = (raw: RawClient["server.foundation"]) => (input: Endpoint18_1Input) =>
  raw["foundation.investigation"]({
    params: { investigationID: input["investigationID"] },
    query: { location: input["location"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint18_2Request = Parameters<RawClient["server.foundation"]["foundation.documents"]>[0]
type Endpoint18_2Input = {
  readonly changeID: Endpoint18_2Request["params"]["changeID"]
  readonly location?: Endpoint18_2Request["query"]["location"]
  readonly search?: Endpoint18_2Request["query"]["search"]
  readonly offset?: Endpoint18_2Request["query"]["offset"]
  readonly limit?: Endpoint18_2Request["query"]["limit"]
}
const Endpoint18_2 = (raw: RawClient["server.foundation"]) => (input: Endpoint18_2Input) =>
  raw["foundation.documents"]({
    params: { changeID: input["changeID"] },
    query: { location: input["location"], search: input["search"], offset: input["offset"], limit: input["limit"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint18_3Request = Parameters<RawClient["server.foundation"]["foundation.document"]>[0]
type Endpoint18_3Input = {
  readonly changeID: Endpoint18_3Request["params"]["changeID"]
  readonly documentID: Endpoint18_3Request["params"]["documentID"]
  readonly location?: Endpoint18_3Request["query"]["location"]
}
const Endpoint18_3 = (raw: RawClient["server.foundation"]) => (input: Endpoint18_3Input) =>
  raw["foundation.document"]({
    params: { changeID: input["changeID"], documentID: input["documentID"] },
    query: { location: input["location"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint18_4Request = Parameters<RawClient["server.foundation"]["foundation.capability"]>[0]
type Endpoint18_4Input = { readonly location?: Endpoint18_4Request["query"]["location"] }
const Endpoint18_4 = (raw: RawClient["server.foundation"]) => (input?: Endpoint18_4Input) =>
  raw["foundation.capability"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint18_5Request = Parameters<RawClient["server.foundation"]["foundation.list"]>[0]
type Endpoint18_5Input = {
  readonly location?: Endpoint18_5Request["query"]["location"]
  readonly scope?: Endpoint18_5Request["query"]["scope"]
  readonly search?: Endpoint18_5Request["query"]["search"]
  readonly offset?: Endpoint18_5Request["query"]["offset"]
  readonly limit?: Endpoint18_5Request["query"]["limit"]
}
const Endpoint18_5 = (raw: RawClient["server.foundation"]) => (input?: Endpoint18_5Input) =>
  raw["foundation.list"]({
    query: {
      location: input?.["location"],
      scope: input?.["scope"],
...
type Endpoint18_6Request = Parameters<RawClient["server.foundation"]["foundation.get"]>[0]
type Endpoint18_6Input = {
  readonly changeID: Endpoint18_6Request["params"]["changeID"]
  readonly location?: Endpoint18_6Request["query"]["location"]
}
const Endpoint18_6 = (raw: RawClient["server.foundation"]) => (input: Endpoint18_6Input) =>
  raw["foundation.get"]({ params: { changeID: input["changeID"] }, query: { location: input["location"] } }).pipe(
    Effect.mapError(mapClientError),
  )

const adaptGroup18 = (raw: RawClient["server.foundation"]) => ({
  investigations: Endpoint18_0(raw),
  investigation: Endpoint18_1(raw),
  documents: Endpoint18_2(raw),
  document: Endpoint18_3(raw),
  capability: Endpoint18_4(raw),
  list: Endpoint18_5(raw),
  get: Endpoint18_6(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  foundation: adaptGroup18(raw["server.foundation"]),
})
