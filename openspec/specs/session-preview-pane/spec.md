# session-preview-pane Specification

## Purpose
TBD - created by archiving change a-session-preview-tab-renders-a-running-dev-server-inside-the-ap. Update Purpose after archive.
## Requirements
