...
- When updating the bundled claude-foundation version, follow [the coding-agent update runbook](docs/FOUNDATION_UPDATE_AGENT.md), including source provenance, integration checks, and the distinction between source updates and binary delivery.
